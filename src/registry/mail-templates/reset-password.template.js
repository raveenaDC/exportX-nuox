 ...
 * @returns {String}
 */
export const resetPasswordTemplate = (name = '', frontEndUrl = '') => {
  // return `hello ${name},\n  have you forgot your password!\n.
  //         \n <a href="${frontEndUrl}">click here</a> to reset password.\n`;
                          ...
                          <tr>
                              <td style="padding: 0;" valign="top">
                                  ...
                                  <p
                                      ...
                                      You're receiving this mail because you requested a password reset for your Exportx Account.
                                      <br>
                                      <br>
                                     Please tap below button to reset your password.
                                  </p>
                                  <a href="${frontEndUrl}"
